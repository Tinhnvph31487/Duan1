...
<head>
    ...
    input[type="radio"] {
        ...
        display: inline-block; /* Display radio buttons in the same line */
        vertical-align: middle; /* Align radio buttons vertically in the middle */
    }

    label {
        display: inline-block; /* Display labels in the same line */
        vertical-align: middle; /* Align labels vertically in the middle */
        margin-right: 15px; /* Adjust the right margin between radio button and label */
    }
</style>
    <!-- CSS
	============================================ -->
        ...
        <div class="row">
                            ...
                            <li><a href="shop.html"> Shop <i class="fa fa-angle-down"></i> </a>
                                <ul class="mega-menu">
                                    ...
                                    <?php
                                        ...
                                        echo '
                                        <li class="mega-menu-title"><a href="'.$linkdm.'">'.$name_dm.'</a></li>
                                        ';
            ...
            <div class="col-xl-2 col-lg-2 col-md-6 col-8">
                  ...
                  if (isset($_SESSION['user'])) {
                   ...
                   <li class="form_li"><a href="view/dhcuaban.php">Đơn hàng của bạn</a></li>
                   <?php if ($role==1) {
