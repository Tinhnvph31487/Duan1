...
<!-- Mirrored from htmldemo.net/flone/flone/login-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Nov 2023 15:03:07 GMT -->
<head>
    <meta charset="utf-8">
                                ...
                                <div class="login-register-form">
                                    <form action="index.php?act=dangnhap" method="post">
                                        ...
                                        <div class="button-box">
                                            ...
                                            <button type="submit" name="dangnhap"><span>Login</span></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="login-form-container">
                                <div class="login-register-form">
                                    ...
                                    <form action="index.php?act=dangky" method="post">
                                        ...
                                        <div class="button-box">
                                            <button type="submit" name="dangky"><span>Đăng kí</span></button>
                                        </div>
                                        <?php
                                        if (isset($thongbao)) {
